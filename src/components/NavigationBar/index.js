            ...
            <NavigationLgContainer bgColor={bgColor}>
              ...
              <ContactInfo>
                ...
                <ContactIcons>
                  ...
                  />
                  <a
                    href="https://www.linkedin.com/in/sairam-polisetty"
                    target="_blank"
            ...
            <NavigationSmallContainer bgColor={bgColor}>
              <NavLink to="/">
                <AiFillHome
                  ...
                  color={activeTab === 'Home' ? '#ff0b37' : '#909090'}
                />
                <SpanEl color={activeTab === 'Home'}>Home</SpanEl>
              </NavLink>
              <NavLink to="/trending">
                <HiFire
                  size={30}
                  ...
                  color={activeTab === 'Trending' ? '#ff0b37' : '#909090'}
                />
                <SpanEl color={activeTab === 'Trending'}>Trending</SpanEl>
              </NavLink>
              <NavLink to="/gaming">
                <SiYoutubegaming
                  size={30}
                  ...
                  color={activeTab === 'Gaming' ? '#ff0b37' : '#909090'}
                />
                <SpanEl color={activeTab === 'Gaming'}>Games</SpanEl>
              </NavLink>
              <NavLink to="/saved-videos">
                <CgPlayListAdd
                  size={30}
                  ...
                  color={activeTab === 'Saved' ? '#ff0b37' : '#909090'}
                />
                <SpanEl color={activeTab === 'Saved'}>Saved videos</SpanEl>
              </NavLink>
            </NavigationSmallContainer>
          </NavBar>
        )
